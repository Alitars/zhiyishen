...
Page({
          ...
          if (res.confirm == true) {
            func.onHistory().then(back => {
              if (id == 1 || id == 2) {
                clickrepeat(text, this).then(res => {
                  ...
                  if (id == 1) {
                    wx.navigateTo({
                      url: '/package/component1/pages/services/same_similar/same_similar?text=' + text + "&imgUrls=" + this.data.create + "&id=" + id + '&key=' + key,
                    });
                  };
                  if (id == 2) {
                    wx.navigateTo({
                      url: '/package/component1/pages/services/same_similar/same_similar?text=' + text + "&imgUrls=" + this.data.imgUrls + "&id=" + id + '&key=' + key,
                    });
                  };
                })
              } else {
                if (id == 3) {
                  ...
                  wx.setStorageSync('groups', groups);
                  wx.navigateTo({
                    url: '/package/component1/pages/services/same_similar/same_similar?text=' + '' + "&imgUrls=" + this.data.imgUrlsTwo + "&id=" + id + '&key=' + key,
                  })
                }
              }
            });
            ...
            if (id == 1 || id == 2) {
              ...
              clickrepeat(text).then(res => {
                if (id == 1) {
                  wx.navigateTo({
                    url: '/package/component1/pages/services/trade/trade?text=' + text + "&imgUrls=" + this.data.create + "&id=" + id,
                  });
                };
                if (id == 2) {
                  wx.navigateTo({
                    url: '/package/component1/pages/services/trade/trade?text=' + text + "&imgUrls=" + this.data.imgUrls + "&id=" + id,
                  });
                };
              })
            } else {
              if (id == 3) {
                ...
                wx.setStorageSync('groups', groups);
                wx.navigateTo({
                  url: '/package/component1/pages/services/trade/trade?text=' + '' + "&imgUrls=" + this.data.imgUrlsTwo + "&id=" + id,
                })
              }
            }
          }
  ...
  onLoad: function (options) {
    // console.log(this.cropper, 'asasasa')
    vioceText({
      data: {
