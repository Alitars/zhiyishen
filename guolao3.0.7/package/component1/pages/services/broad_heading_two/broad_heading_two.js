...
Page({
  ...
  onChoose(e) {
    ...
    if (value) {
      wx.navigateTo({
        url: '/package/component1/pages/services/add_small_two/add_small_two?num=' + num + '&name=' + name + '&value=' + value,
      })
    } else {
      wx.navigateTo({
        url: '/package/component1/pages/services/add_small_two/add_small_two?num=' + num + '&name=' + name,
      })
    }
  },
  getType() {
