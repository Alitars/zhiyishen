        ...
        if (ss) {
          wx.showModal({
            ...
            success: (res => {
              if (res.confirm == true) {
                wx.navigateTo({
                  url: '/package/component1/pages/intitle/same_similar/same_similar?text=' + name + '&num=' + num,
                });
              } else {
                wx.navigateTo({
                  url: '/package/component1/pages/intitle/brand_name/brand_name?name=' + name + '&num=' + num,
                })
              }
            })
          })
