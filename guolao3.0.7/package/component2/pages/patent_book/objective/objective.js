...
Page({
  ...
  onClick() {
    ...
    list.ans6 = this.data.value
    var json = JSON.stringify(list)
    wx.redirectTo({
      url:'/package/component2/pages/patent_book/create/create?compose='+this.data.compose+'&list='+ json,
    })
  },
  onSlider(e) {
  ...
  onLoad: function (options) {
    ...
    vioceText({
      data: {
        content: '请问是否还有别的替代方案同样能完成此发明目的，如须帮助请点击示例查看',
      },
    })
  },
