...
Page({
  ...
  onClick() {
    ...
    list.ans4 = this.data.value
    var json = JSON.stringify(list)
    wx.navigateTo({
      url:'/package/component2/pages/patent_book/plan/plan?compose='+this.data.compose+'&list='+ json,
    })
  },
  onSlider(e) {
  ...
  onLoad: function (options) {
    ...
    vioceText({
      data: {
        content: '请描述该结构改进带来的有益效果，如产能、质量、精度的提高，效率的增加',
      },
    })
  },
