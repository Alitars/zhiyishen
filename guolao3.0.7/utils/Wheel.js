...
function Circle(x, y, radius, slicePrizes) {
  ...
  this.colors = ["#FFEAA7","#FCF9F0"];
  this.prizeWidth = 20;
  this.prizeHeight = 20;
  this.prizeFontSize = 12;
...
Circle.prototype.draw = function (context) {
  ...
  for (var i = 0; i < size; i++) {
    ...
    // context.drawImage(prize.img, -15, -30, 34, this.prizeHeight);
    ...
    // context.setFillStyle('#f91')
    // context.textAlign = "center";
    // context.fillText(prize.num, 1, (offset - 70) * -1)
