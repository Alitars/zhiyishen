...
Page({
  ...
  toCheck(){
    ...
    if(this.data.styleIndex == 0){
      wx.navigateTo({
        url: '/package/component/pages/services/hs_check/hs_check?brandname='+this.data.value+'&shareId='+this.data.shareId+'&imgUrl='+this.data.strimg,
      })
    }else if(this.data.styleIndex == 1){
      wx.navigateTo({
        url: '/package/component/pages/services/hs_check/hs_check?brandname=&shareId='+this.data.shareId+'&imgUrl='+this.data.create,
      })
    }
