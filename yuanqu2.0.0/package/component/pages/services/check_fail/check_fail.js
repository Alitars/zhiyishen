...
Page({
  ...
  onRecord(arry) {
    ...
    Toast.clear();
    wx.navigateTo({
      url: '/package/component/pages/services/recommend/recommend?arry=' + JSON.stringify(arry) + '&list=' + JSON.stringify(list) + '&name=' + this.data.text + '&imgUrls=' + this.data.imgUrls,
    });
  },
  getType() {
    paydetail()
