...
Page({
      ...
      NetworkRequest({
        ...
        if (code == 1) {
          ...
          for (var i = 0; i < arry.length; i++) {
            ...
            if (arry.isSelect == true && active == 1 && arry.isShow == false) {
              num++;
            };
          };
          if (active == 1) {
  ...
  onSubmitZiliao(e) {
    ...
    if (link == 'gl://submitchesanshenqing?edit=0') {
      wx.navigateTo({
        url: '/package/component/pages/material/Up_ziliao/Up_ziliao?apply_id=' + apply_id + '&click_type=' + click_type + '&order_id=' + order_id + '&one_cate=' + one_cate + '&type=' + 2,
      })
    };
    //提交资料 商标异议答辩
    ...
    if (link == 'gl://submitbufazhucezheng?edit=0') {
      wx.navigateTo({
        url: '/package/component/pages/material/Up_ziliao/Up_ziliao?apply_id=' + apply_id + '&click_type=' + click_type + '&order_id=' + order_id + '&one_cate=' + one_cate + '&type=' + 4,
      })
    };
    //提交资料 商标转让
    if (link == 'gl://submitzhuanrang?edit=0') {
      wx.navigateTo({
        url: '/package/component/pages/material/Up_ziliao/Up_ziliao?apply_id=' + apply_id + '&click_type=' + click_type + '&order_id=' + order_id + '&one_cate=' + one_cate + '&type=' + 6,
      })
    };
    //提交资料 商标变更
    if (link == 'gl://submitbiangeng?edit=0') {
      wx.navigateTo({
        url: '/package/component/pages/material/Up_ziliao/Up_ziliao?apply_id=' + apply_id + '&click_type=' + click_type + '&order_id=' + order_id + '&one_cate=' + one_cate + '&type=' + 7,
      })
    };
    //提交资料 商标续展
    if (link == 'gl://submitxuzhan?edit=0') {
      wx.navigateTo({
        url: '/package/component/pages/material/Up_ziliao/Up_ziliao?apply_id=' + apply_id + '&click_type=' + click_type + '&order_id=' + order_id + '&one_cate=' + one_cate + '&type=' + 8,
      })
    }
    //提交资料 商标许可备案
    if (link == 'gl://submitxukebeian?edit=0') {
      wx.navigateTo({
        url: '/package/component/pages/material/Up_ziliao/Up_ziliao?apply_id=' + apply_id + '&click_type=' + click_type + '&order_id=' + order_id + '&one_cate=' + one_cate + '&type=' + 5,
      })
    };
  },
  ...
  onLeft(e) {
    ...
    // if (link == 'gl://submitzhuce?edit=0') {
    //   wx.navigateTo({
    //     url: '/package/component/pages/material/Up_ziliao/Up_ziliao?apply_id=' + apply_id + '&click_type=' + click_type + '&order_id=' + order_id + '&one_cate=' + one_cate + '&type=' + 1,
    //   })
    //   // Toast('您已提交过资料)
    // };
    if (link == 'gl://submitzhuce?edit=0') {
    ...
    //   wx.navigateTo({
    //     url: '/package/component/pages/material/revise_Up_ziliao/revise_Up_ziliao?apply_id=' + apply_id + '&click_type=' + click_type + '&order_id=' + order_id + '&one_cate=' + one_cate + '&type=' + 1,
    //   })
    // } 
    if (link == 'gl://submitzhuce?edit=1') {
      wx.navigateTo({
    ...
    if (link == 'gl://submitchesanshenqing?edit=1') {
      wx.navigateTo({
        url: '/package/component/pages/material/revise_Up_ziliao/revise_Up_ziliao?apply_id=' + apply_id + '&click_type=' + click_type + '&order_id=' + order_id + '&one_cate=' + one_cate + '&type=' + 2,
      })
    }
    //商标许可备案 修改资料
    if (link == 'gl://submitxukebeian?edit=1') {
      wx.navigateTo({
        url: '/package/component/pages/material/revise_Up_ziliao/revise_Up_ziliao?apply_id=' + apply_id + '&click_type=' + click_type + '&order_id=' + order_id + '&one_cate=' + one_cate + '&type=' + 5,
      })
    }
    //商标变更 修改资料
    if (link == 'gl://submitbiangeng?edit=1') {
      wx.navigateTo({
        url: '/package/component/pages/material/revise_Up_ziliao/revise_Up_ziliao?apply_id=' + apply_id + '&click_type=' + click_type + '&order_id=' + order_id + '&one_cate=' + one_cate + '&type=' + 7,
      })
    }
    //商标续展 修改资料
    if (link == 'gl://submitxuzhan?edit=1') {
      wx.navigateTo({
        url: '/package/component/pages/material/revise_Up_ziliao/revise_Up_ziliao?apply_id=' + apply_id + '&click_type=' + click_type + '&order_id=' + order_id + '&one_cate=' + one_cate + '&type=' + 8,
      })
    }
    //商标转让 修改资料
    if (link == 'gl://submitzhuanrang?edit=1') {
      wx.navigateTo({
        url: '/package/component/pages/material/revise_Up_ziliao/revise_Up_ziliao?apply_id=' + apply_id + '&click_type=' + click_type + '&order_id=' + order_id + '&one_cate=' + one_cate + '&type=' + 6,
      })
    }
    //补发商标注册证  修改资料
    ...
    if (link == 'gl://submitbufazhucezheng?edit=1') {
      wx.navigateTo({
        url: '/package/component/pages/material/revise_Up_ziliao/revise_Up_ziliao?apply_id=' + apply_id + '&click_type=' + click_type + '&order_id=' + order_id + '&one_cate=' + one_cate + '&type=' + 4,
      })
    }
    ...
    if (link == 'gl://checkobjectionyiyi?edit=0') {
      wx.navigateTo({
        url: '/package/component/pages/material/recheck/recheck?apply_id=' + apply_id + '&click_type=' + click_type + '&order_id=' + order_id + '&one_cate=' + one_cate + '&type=' + 0,
      })
    }
    // 查看正文 商标异议答辩
    if (link == 'gl://checkobjectionreplysbyy?edit=0') {
      wx.navigateTo({
        url: '/package/component/pages/material/recheck/recheck?apply_id=' + apply_id + '&click_type=' + click_type + '&order_id=' + order_id + '&one_cate=' + one_cate + '&type=' + 1,
      })
    }
    // 查看正文 商标撤三答辩
    if (link == 'gl://checkchesanreply?edit=0') {
      wx.navigateTo({
        url: '/package/component/pages/material/recheck/recheck?apply_id=' + apply_id + '&click_type=' + click_type + '&order_id=' + order_id + '&one_cate=' + one_cate + '&type=' + 2,
      })
    }
    //正文不同意 商标撤三答辩
    ...
    if (link == 'gl://checkreviewbohuifushen') {
      wx.navigateTo({
        url: '/package/component/pages/material/recheck/recheck?apply_id=' + apply_id + '&click_type=' + click_type + '&order_id=' + order_id + '&one_cate=' + one_cate + '&type=' + 3,
      })
    }
    ...
    if (link == 'gl://payendzhuce') {
      ...
      wx.navigateTo({
        url: '/package/component/pages/material/balance_payment/balance_payment',
      })
    }
  ...
  onRight(e) {
    ...
    if (link == 'gl://sealzhuce?edit=0') {
      wx.navigateTo({
        url: '/package/component/pages/material/Upload_file/Upload_file?order_id=' + order_id + '&type=' + 0 + '&click_type=' + click_type,
      })
    }
    gl: //sealxuzhan?edit=0
      ...
      if (link == 'gl://sealbiangeng?edit=0') {
        wx.navigateTo({
          url: '/package/component/pages/material/Upload_file/Upload_file?order_id=' + order_id + '&type=' + 1 + '&click_type=' + click_type,
        })
      }
    ...
    if (link == 'gl://sealzhuanrang?edit=0') {
      wx.navigateTo({
        url: '/package/component/pages/material/Upload_file/Upload_file?order_id=' + order_id + '&type=' + 2 + '&click_type=' + click_type,
      })
    }
    ...
    if (link == 'gl://sealxukebeian?edit=0') {
      wx.navigateTo({
        url: '/package/component/pages/material/Upload_file/Upload_file?order_id=' + order_id + '&type=' + 4 + '&click_type=' + click_type,
      })
    }

    //上传盖章资料 商标续展
    if (link == 'gl://sealxuzhan?edit=0') {
      wx.navigateTo({
        url: '/package/component/pages/material/Upload_file/Upload_file?order_id=' + order_id + '&type=' + 3 + '&click_type=' + click_type,
      })
    }
    //上传盖章资料 商标撤三申请   
    if (link == 'gl://sealchesanshenqing?edit=0') {
      wx.navigateTo({
        url: '/package/component/pages/material/Upload_file/Upload_file?order_id=' + order_id + '&type=' + 6 + '&click_type=' + click_type,
      })
    }
    // 上传盖章资料  补发商标注册证申请书
    if (link == 'gl://sealbufazhucezheng?edit=0') {
      wx.navigateTo({
        url: '/package/component/pages/material/Upload_file/Upload_file?order_id=' + order_id + '&type=' + 5 + '&click_type=' + click_type,
      })
    }
    ...
    if (link == 'gl://mailsealbohuifushen') {
      wx.navigateTo({
        url: '/package/component/pages/material/send_by_post/send_by_post?id=' + 1,
      })
    }
    ...
    if (link == 'gl://mailsealsbyiyi') {
      wx.navigateTo({
        url: '/package/component/pages/material/send_by_post/send_by_post?id=' + 2,
      })
    }
    //邮寄盖章资料 商标异议答辩
    if (link == 'gl://mailsealyiyidabian') {
      wx.navigateTo({
        url: '/package/component/pages/material/send_by_post/send_by_post?id=' + 3,
      })
    }
    ...
    if (link == 'gl://mailsealchesanshenqing') {
      wx.navigateTo({
        url: '/package/component/pages/material/send_by_post/send_by_post?id=' + 4,
      })
    }
    ...
    if (link == 'gl://mailsealchesan') {
      wx.navigateTo({
        url: '/package/component/pages/material/send_by_post/send_by_post?id=' + 5,
      })
    }
    ...
    if (link == 'gl://pay') {
      wx.setStorageSync('id', id);
      wx.navigateTo({
        url: '/package/component/pages/services/pay/pay?open=' + true,
      })
    }
  ...
  onReady: function () {
    // var info = getApp().globalData.menuInfo
    // var height = info.height + info.top
  },
