...
import NetworkRequest from '../../../template/copyright';
...
Page({
  ...
  onFist(e) {
    ...
    //详情
    wx.navigateTo({
      url: '/pages/user/my_copyright/dt/dt?id=' + id + '&click_type=' + click_type,
    })
  },
  onLeft(e) {
    var index = e.currentTarget.dataset.index;
    ...
    if (link == 'gl://submitzhuce?edit=0') {
      wx.navigateTo({
        url: '/package/component/pages/material/patent_Up_ziliao/patent_Up_ziliao?click_type=' + click_type + '&order_id=' + order_id + '&type=' + 4 + '&id=' + id,
      })
    }
    //专利变更申请提交资料
    if (link == 'gl://submitchange?edit=0') {
      wx.navigateTo({
        url: '/package/component/pages/material/patent_Change_ziliao/patent_Change_ziliao?click_type=' + click_type + '&order_id=' + order_id + '&type=' + 4 + '&id=' + id,
      })
    }
    //专利变更申请提交资料
    if (link == 'gl://submitchanges?edit=1') {
      wx.navigateTo({
        url: '/package/component/pages/material/patent_Change_ziliao_edit/patent_Change_ziliao_edit?click_type=' + click_type + '&order_id=' + order_id + '&type=' + 4 + '&id=' + id,
      })
    }
    //专利转让申请提交资料
    if (link == 'gl://submitmove?edit=0') {
      wx.navigateTo({
        url: '/package/component/pages/material/patent_transfer_ziliao/patent_transfer_ziliao?click_type=' + click_type + '&order_id=' + order_id + '&type=' + 4 + '&id=' + id,
      })
    }
    // 专利转让申请修改资料
    if (link == 'gl://submitmoves?edit=1') {
      wx.navigateTo({
        url: '/package/component/pages/material/patent_transfer_ziliao_edit/patent_transfer_ziliao_edit?click_type=' + click_type + '&order_id=' + order_id + '&type=' + 4 + '&id=' + id,
      })
    }

    //查看缴费第一次
    if (link == 'gl://getNotices') {
      route('package/component/pages/patent/look_pay/look_pay?click_type=' + click_type + '&order_id=' + order_id + '&type=' + 4 + '&id=' + id + '&num=' + 1);
    }
    //实用新型专利申请修改资料
    if (link == 'gl://submitpatent?edit=1') {
      route('package/component/pages/material/patent_Up_ziliao_edit/patent_Up_ziliao_edit?click_type=' + click_type + '&order_id=' + order_id + '&type=' + 4 + '&id=' + id, );
    };
    //实用新型专利申请 确认材料
    if (link == 'gl://getSynopsis') {
      route('package/component/pages/patent/confirmation_material_first/confirmation_material_first?click_type=' + click_type + '&order_id=' + order_id + '&type=' + 4 + '&id=' + id);
    };
    //发明专利申请
    ...
    if (link == 'gl://getOpinion') {
      wx.navigateTo({
        url: '/package/component/pages/patent/makings/makings?click_type=' + click_type + '&order_id=' + order_id + '&type=' + 4 + '&id=' + id,
      })
    };
    //查看缴费第二次
    if (link == 'gl://payRegisterInfo') {
      // console.log('asasass')
      wx.navigateTo({
        url: '/package/component/pages/patent/look_pay/look_pay?click_type=' + click_type + '&order_id=' + order_id + '&type=' + 4 + '&id=' + id + '&num=' + 2
      })
    };
    //确认收货
  ...
  getData(e) {
    ...
    NetworkRequest({
      ...
      data: {
        ...
        order_no: '',
        patent_no: '',
        status: (typeof (id) == 'string') ? JSON.parse(id): id,
        // token: token,
      },
      method: 'POST',
    }).then(res => {
