<template>
  <div class="patentTransferPay">
    <Top></Top>
    <Fix></Fix>
    <div class="patentTransferPay-box">
      <!-- top -->
      <div class="patentTransferPay-box-top">
       专利转让申请缴费
      </div>
      <!-- 著录项变更缴费通知书 -->
      <div class="patentTransferPay-box-one">
        <div class="one-left">
      ...
      <!-- 费用明细 -->
      <div class="patentTransferPay-box-detail">
        <p>费用明细：</p>
        <span>申请费：￥{{apply_fee}}</span>
        <span>实审费：￥{{trial_fee}}</span>
      </div>
      <!--  选择  -->
      <div class="patentTransferPay-box-select">
        <p>是否代缴官费：</p>
      ...
      <!-- 支付方式 -->
      <div class="patentTransferPay-box-way" v-show="switch1">
        <p>支付方式：</p>
        <div :class="active">
      ...
      <!-- 总金额 -->
      <div class="patentTransferPay-box-money" v-show="switch1">
        <p>总计金额:</p>
        <p>RMB <span>{{total_fee}}</span></p>
      </div>
      <!-- 提示 -->
      <div class="patentTransferPay-box-prompt" v-show="switch2">
      ...
      <!-- 提交&&取消 -->
      <div class="patentTransferPay-box-submit" >
...
<style scoped>
  ...
  /* 费用明细 */
  .patentTransferPay-box-detail {
    border-top: 1px solid #d8d8d8;
    padding-bottom: 32px;
    border-bottom: 1px solid #d8d8d8;
  }
  .patentTransferPay-box-detail > p {
  ...
  .patentTransferPay-box-detail > span {
    font-family: "PingFangSC";
    font-size: 18px;
    margin-right: 96px;
  }
  /* 选择 */
  .patentTransferPay-box-select {
    margin: 36px 0 36px 0px;
    border-bottom: 1px solid #d8d8d8;
    padding-bottom: 16px;
  }
  .patentTransferPay-box-select > p {
    font-family: "PingFangSC";
    font-size: 20px;
    margin-bottom: 16px;
    color: #333333;
  ...
  .patentTransferPay-box-select > input {
    width: 18px;
    height: 18px;
  ...
  .patentTransferPay-box-select > span {
    font-family: "PingFangSC";
    font-size: 20px;
    vertical-align: middle;
    margin-right: 65px;
  ...
  /* 支付方式 */
  .patentTransferPay-box-way {
    margin: 0px 0 36px 0;
    border-bottom: 1px solid #d8d8d8;
    padding-bottom: 36px;
  }
  .patentTransferPay-box-way > p {
    font-family: "PingFangSC";
    font-size: 22px;
    font-weight: 600;
  }
  ...
  /* 总金额 */
  .patentTransferPay-box-money > p:nth-child(1) {
    font-family: "PingFangSC";
    font-size: 22px;
    font-weight: 600;
    color: #333;
  ...
  .patentTransferPay-box-money > p:nth-child(2) {
    font-family: "PingFangSC";
    font-size: 26px;
    font-weight: 600;
    color: #333;
  }
  .patentTransferPay-box-money > p:nth-child(2) >span {
    color: #f96006;
  }
  /* 提示 */
  .patentTransferPay-box-prompt > p {
    font-family: "PingFangSC";
    font-size: 22px;
    font-weight: 600;
    color: #333;
  ...
  .patentTransferPay-box-prompt > div > a {
    font-family: "PingFangSC";
    font-size: 22px;
    font-weight: 600;
    color: #f96006;
  ...
  /* 提交&&取消 */
  .patentTransferPay-box-submit {
    float: right;
    margin:64px 0px 0 0 ;
  }
  .patentTransferPay-box-submit > span {
    width: 214px;
    height: 54px;
  ...
  .patentTransferPay-box-submit > span:nth-child(2) {
  ...
  .patentTransferPay-box-submit > span:nth-child(1) {

    border-radius: 4px;
    color: #f87604;
  }
    .patentTransferPay-box-submit > span:nth-child(3) {
    border-image-source: linear-gradient(0deg,#ba6100,#dc773b);
    border-image-slice: 1;
    background-image: linear-gradient(180deg,#f79000,#f96006),linear-gradient(0deg,#ba6100,#dc773b);
    background-origin: border-box;
