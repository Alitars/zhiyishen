<template>
  <div class="patentNewAuthorizationPay">
    <Top></Top>
    <Fix></Fix>
    <div class="patentNewAuthorizationPay-box">
      <!-- top -->
      <div class="patentNewAuthorizationPay-box-top">
       实用新型发明专利申请受理缴费
      </div>
      <!-- 受理通知书 -->
      <div class="patentNewAuthorizationPay-box-one">
        <div class="one-left">
      ...
      <!-- 费用明细 -->
      <div class="patentNewAuthorizationPay-box-detail">
        <p>费用明细：</p>
        <span>授权费：￥{{auth_fee}}</span>

      </div>
      <!--  选择  -->
      <div class="patentNewAuthorizationPay-box-select">
        <p>是否代缴官费：</p>
      ...
      <!-- 支付方式 -->
      <div class="patentNewAuthorizationPay-box-way" v-show="switch1">
        <p>支付方式：</p>
        <div :class="active">
      ...
      <!-- 总金额 -->
      <div class="patentNewAuthorizationPay-box-money" v-show="switch1">
        <p>总计金额:</p>
        <p>RMB <span>{{auth_fee}}</span></p>
      </div>
      <!-- 提示 -->
      <div class="patentNewAuthorizationPay-box-prompt" v-show="switch2">
      ...
      <!-- 提交&&取消 -->
      <div class="patentNewAuthorizationPay-box-submit" >
...
<script>
  ...
  export default {
  name:'patentNewAuthorizationPay',
  components:{
    Top,
    Foot,
    Fix
...
<style scoped>
  ...
  /* top */
  .patentNewAuthorizationPay-box-top {
    height: 110px;
    line-height: 110px;
  ...
  /* 说明书&&委托书 */
  .patentNewAuthorizationPay-box-one {
    height: 230px;
  ...
  /* 费用明细 */
  .patentNewAuthorizationPay-box-detail {
    border-top: 1px solid #d8d8d8;
    padding-bottom: 32px;
    border-bottom: 1px solid #d8d8d8;
  }
  .patentNewAuthorizationPay-box-detail > p {
  ...
  .patentNewAuthorizationPay-box-detail > span {
    font-family: "PingFangSC";
    font-size: 18px;
    margin-right: 96px;
  }
  /* 选择 */
  .patentNewAuthorizationPay-box-select {
    margin: 36px 0 36px 0px;
    border-bottom: 1px solid #d8d8d8;
    padding-bottom: 16px;
  }
  .patentNewAuthorizationPay-box-select > p {
    font-family: "PingFangSC";
    font-size: 20px;
    margin-bottom: 16px;
    color: #333333;
  ...
  .patentNewAuthorizationPay-box-select > input {
    width: 18px;
    height: 18px;
  ...
  .patentNewAuthorizationPay-box-select > span {
    font-family: "PingFangSC";
    font-size: 20px;
    vertical-align: middle;
    margin-right: 65px;
  ...
  /* 支付方式 */
  .patentNewAuthorizationPay-box-way {
    margin: 0px 0 36px 0;
    border-bottom: 1px solid #d8d8d8;
    padding-bottom: 36px;
  }
  .patentNewAuthorizationPay-box-way > p {
    font-family: "PingFangSC";
    font-size: 22px;
    font-weight: 600;
  }
  ...
  /* 总金额 */
  .patentNewAuthorizationPay-box-money > p:nth-child(1) {
    font-family: "PingFangSC";
    font-size: 22px;
    font-weight: 600;
    color: #333;
  ...
  .patentNewAuthorizationPay-box-money > p:nth-child(2) {
    font-family: "PingFangSC";
    font-size: 26px;
    font-weight: 600;
    color: #333;
  }
  .patentNewAuthorizationPay-box-money > p:nth-child(2) >span {
    color: #f96006;
  }
  /* 提示 */
  .patentNewAuthorizationPay-box-prompt > p {
    font-family: "PingFangSC";
    font-size: 22px;
    font-weight: 600;
    color: #333;
  ...
  .patentNewAuthorizationPay-box-prompt > div > a {
    font-family: "PingFangSC";
    font-size: 22px;
    font-weight: 600;
    color: #f96006;
  ...
  /* 提交&&取消 */
  .patentNewAuthorizationPay-box-submit {
    float: right;
    margin:64px 0px 0 0 ;
  }
  .patentNewAuthorizationPay-box-submit > span {
    width: 214px;
    height: 54px;
  ...
  .patentNewAuthorizationPay-box-submit > span:nth-child(2) {
  ...
  .patentNewAuthorizationPay-box-submit > span:nth-child(1) {

    border-radius: 4px;
    color: #f87604;
  }
    .patentNewAuthorizationPay-box-submit > span:nth-child(3) {
    border-image-source: linear-gradient(0deg,#ba6100,#dc773b);
    border-image-slice: 1;
    background-image: linear-gradient(180deg,#f79000,#f96006),linear-gradient(0deg,#ba6100,#dc773b);
    background-origin: border-box;
