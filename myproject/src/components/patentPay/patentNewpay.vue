<template>
  <div class="patentNewpay">
    <Top></Top>
    <Fix></Fix>
    <div class="patentNewpay-box">
      <!-- top -->
      <div class="patentNewpay-box-top">
       实用新型专利申请缴费
      </div>
      <!-- 受理通知书 -->
      <div class="patentNewpay-box-one">
        <div class="one-left">
      ...
      <!-- 费用明细 -->
      <div class="patentNewpay-box-detail">
        <p>费用明细：</p>
        <span>申请费：￥{{apply_fee}}</span>
        <span>实审费：￥{{trial_fee}}</span>
      </div>
      <!--  选择  -->
      <div class="patentNewpay-box-select">
        <p>是否代缴官费：</p>
      ...
      <!-- 支付方式 -->
      <div class="patentNewpay-box-way" v-show="switch1">
        <p>支付方式：</p>
        <div :class="active">
      ...
      <!-- 总金额 -->
      <div class="patentNewpay-box-money" v-show="switch1">
        <p>总计金额:</p>
        <p>RMB <span>{{total_fee}}</span></p>
      </div>
      <!-- 提示 -->
      <div class="patentNewpay-box-prompt" v-show="switch2">
      ...
      <!-- 提交&&取消 -->
      <div class="patentNewpay-box-submit" >
...
<style scoped>
  ...
  /* 费用明细 */
  .patentNewpay-box-detail {
    border-top: 1px solid #d8d8d8;
    padding-bottom: 32px;
    border-bottom: 1px solid #d8d8d8;
  }
  .patentNewpay-box-detail > p {
  ...
  .patentNewpay-box-detail > span {
    font-family: "PingFangSC";
    font-size: 18px;
    margin-right: 96px;
  }
  /* 选择 */
  .patentNewpay-box-select {
    margin: 36px 0 36px 0px;
    border-bottom: 1px solid #d8d8d8;
    padding-bottom: 16px;
  }
  .patentNewpay-box-select > p {
    font-family: "PingFangSC";
    font-size: 20px;
    margin-bottom: 16px;
    color: #333333;
  ...
  /* 支付方式 */
  .patentNewpay-box-way {
    margin: 0px 0 36px 0;
    border-bottom: 1px solid #d8d8d8;
    padding-bottom: 36px;
  }
  .patentNewpay-box-way > p {
    font-family: "PingFangSC";
    font-size: 22px;
    font-weight: 600;
  }
  ...
  /* 总金额 */
  .patentNewpay-box-money > p:nth-child(1) {
    font-family: "PingFangSC";
    font-size: 22px;
    font-weight: 600;
    color: #333;
  ...
  .patentNewpay-box-money > p:nth-child(2) {
    font-family: "PingFangSC";
    font-size: 26px;
    font-weight: 600;
    color: #333;
  }
  .patentNewpay-box-money > p:nth-child(2) >span {
    color: #f96006;
  }
  /* 提示 */
  .patentNewpay-box-prompt > p {
    font-family: "PingFangSC";
    font-size: 22px;
    font-weight: 600;
    color: #333;
  ...
  /* 提交&&取消 */
  .patentNewpay-box-submit {
    float: right;
    margin:64px 0px 0 0 ;
  }
  .patentNewpay-box-submit > span {
    width: 214px;
    height: 54px;
  ...
  .patentNewpay-box-submit > span:nth-child(2) {
  ...
  .patentNewpay-box-submit > span:nth-child(1) {

    border-radius: 4px;
    color: #f87604;
  }
    .patentNewpay-box-submit > span:nth-child(3) {
    border-image-source: linear-gradient(0deg,#ba6100,#dc773b);
    border-image-slice: 1;
    background-image: linear-gradient(180deg,#f79000,#f96006),linear-gradient(0deg,#ba6100,#dc773b);
    background-origin: border-box;
