<template>
  <div class="protocol">
    <div class="protocol-box">
        ...
        <p class="p1">欢迎您加入知依昇（www.iguolao.com），您的支持将是我们前进的动力！
            为保障您的权益，在正式成为本网站用户前，请您认真仔细阅读本协议，
            谢谢您的配合！</p>
        <p class="p2">知依昇系由知昇（上海）人工智能科技有限公司成立并运营，
            以下所称“本网站”即包含了知依昇本身及网站所有者知昇（上海）人工智能科技有限公司。
        ...
        <p class="p2">因本网站提供服务所产生的争议均适用中华人民共和国法律，并由本网站住所地的上海市松江区人民法院管辖。</p>
