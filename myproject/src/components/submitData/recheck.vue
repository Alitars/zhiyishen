<template>
  <div id="recheck">
    ...
    <div class="recheck-box">
      ...
      <div class="recheck-box-wrap">
          <div class="recheck-box-wrap-top">商标驳回复审</div>
          <div class="fail" v-if="status == '资料审核不通过'">审核不通过原因：{{remark}}</div>
          <div class="recheck-box-wrap-middle">
            <div class="recheck-box-wrap-middle-type">申请人类型：</div>
            <div class="recheck-box-middle-radio">
              ...
              <div class="recheck-box-middle-box-company" v-show="divshow">
                <p>企业全称：</p>
              ...
              <div class="recheck-box-middle-box-registerNum">
                  <div>商标注册号：</div>
              ...
              <div class="recheck-box-middle-box-evance">
                  <div>复审证据资料：</div>
                  <div>
                      <div> 
                        <input type="file" @change="getFile($event)">
                    </div>
                    <div class="recheck-box-middle-box-evance-des"> 说明：压缩包200M以内，太大联系客服；资料包含(发票，合同，广告投入，
                        产品包装，检验报告，商标印制证明，商标创意来源说明)</div>
                  </div>
              </div>
              <div class="recheck-box-middle-two">
...
<style scoped>
  ...
  .recheck-box-wrap-middle-type{
    margin: 28px 0 17px;
    font-family: "PingFangSC-Regular";
    font-size: 24px;
    color: #333333;
  }
  .recheck-box-middle-radio>input{
    width: 24px;
    height: 24px;
    vertical-align: middle;
    margin-right: 12px;
  }
  .recheck-box-middle-radio>span{
    font-family: "PingFangSC-Regular";
    font-size: 20px;
    vertical-align: middle;
    font-weight: 300;
  ...
  .recheck-box-middle-radio>span:nth-of-type(1){
    margin-right: 45px;
  }
  .form_select {
...
.recheck-box-middle-box-company{
  margin: 28px 0;
}
.recheck-box-middle-box-company>p,.recheck-box-middle-box-ming>p{
  font-family: "PingFangSC-Regular";
  font-size: 24px;
  color: #333333;
}
.recheck-box-middle-box-company>span{
  font-family: "PingFangSC-Regular";
  font-size: 24px;
  color: #f96006;
  cursor: pointer;
}
.recheck-box-middle-box-registerNum{
    margin-bottom: 28px;
}
.recheck-box-middle-box-registerNum>div{
    margin-bottom: 15px;
    font-family: "PingFangSC-Regular";
    font-size: 24px;
    color: #333333;
}
.recheck-box-middle-box-registerNum>input{
     width: 776px;
     height: 40px;
     border-radius: 4px;
     border: solid 1px #d6d6d6;
...
.recheck-box-middle-box-evance{
    margin-bottom: 200px;
}
.recheck-box-middle-box-evance>div:nth-of-type(1){
     margin-bottom: 20px;
     font-family: "PingFangSC-Regular";
    font-size: 24px;
    color: #333333;
}
.recheck-box-middle-box-evance>div:nth-of-type(2)>div{
    float: left;
}
.recheck-box-middle-box-evance-des{
    width: 545px;
    height: 44px;
...
.recheck-box-middle-two{
      height: 53px;
      margin-left: 540px;
    }
    .recheck-box-middle-two>div{
      float: left;
      width: 182px;
      height: 53px;
      border-radius: 8px;
    ...
    .recheck-box-middle-two>div:nth-of-type(1){
    ...
    .recheck-box-middle-two>div:nth-of-type(2){
