<template>
  <div id="extension">
    ...
    <div class="extension-box">
      ...
      <div class="extension-box-wrap">
          <div class="extension-box-wrap-top">{{this.$route.query.click_type}}</div>
          <div class="fail" v-if="status == '资料审核不通过'">审核不通过原因：{{remark}}</div>
          <div class="extension-box-wrap-middle">
            <div class="extension-box-wrap-middle-type">申请人类型：</div>
            <div class="extension-box-middle-radio">
              ...
              <div class="extension-box-middle-box-company" v-show="divshow">
                <p>企业全称：</p>
              ...
              <div class="extension-box-middle-box-registerNum">
                  <div>商标注册号：</div>
              ...
              <div class="extension-box-middle-two">
...
<style scoped>
  ...
  .extension-box-wrap-middle-type{
    margin: 28px 0 17px;
    font-family: "PingFangSC-Regular";
    font-size: 24px;
    color: #333333;
  }
  .extension-box-middle-radio>input{
    width: 24px;
    height: 24px;
    vertical-align: middle;
    margin-right: 12px;
  }
  .extension-box-middle-radio>span{
    font-family: "PingFangSC-Regular";
    font-size: 20px;
    vertical-align: middle;
    font-weight: 300;
  ...
  .extension-box-middle-radio>span:nth-of-type(1){
    margin-right: 45px;
  }
  .form_select {
...
.extension-box-middle-box-company{
  margin: 28px 0;
}
.extension-box-middle-box-company>p,.extension-box-middle-box-ming>p{
  font-family: "PingFangSC-Regular";
  font-size: 24px;
  color: #333333;
}
.extension-box-middle-box-company>span{
  font-family: "PingFangSC-Regular";
  font-size: 24px;
  color: #f96006;
  cursor: pointer;
}
.extension-box-middle-box-registerNum{
    margin-bottom: 28px;
}
.extension-box-middle-box-registerNum>div{
    margin-bottom: 15px;
    font-family: "PingFangSC-Regular";
    font-size: 24px;
    color: #333333;
}
.extension-box-middle-box-registerNum>input{
     width: 776px;
     height: 40px;
     border-radius: 4px;
     border: solid 1px #d6d6d6;
...
.extension-box-middle-two{
      height: 53px;
      margin-left: 540px;
      margin-top: 200px;
    }
.extension-box-middle-two>div{
    float: left;
    width: 182px;
    height: 53px;
    border-radius: 8px;
...
.extension-box-middle-two>div:nth-of-type(1){
...
.extension-box-middle-two>div:nth-of-type(2){
