  ...
  <div id="threeAnswer">
    ...
    <div class="three-box">
      ...
      <div class="three-box-wrap">
          <div class="three-box-wrap-top"> 商标撤三答辩</div>
          <div class="fail" v-if="status == '资料审核不通过'">审核不通过原因：{{remark}}</div>
          <div class="three-box-wrap-middle">
            <div class="three-box-wrap-middle-type">申请人类型：</div>
            <div class="three-box-middle-radio">
              ...
              <div class="three-box-middle-box-company" v-show="divshow">
                <p>企业全称：</p>
              ...
              <div class="three-box-middle-box-registerNum">
                  <div>商标注册号：</div>
              ...
              <div class="three-box-middle-box-evance">
                  <div>商标撤三答辩资料：</div>
                  <div>
                      <div> 
                        <input type="file" @change="getFile($event)">
                    </div>
                    <div class="three-box-middle-box-evance-des">RAR或ZIP格式，压缩包200M以内，太大联系客服；
                        资料包含(商品企业简介、企业发展历程、销售或使用等证明材料)</div>
                  </div>
              </div>
              <div class="three-box-middle-two">
...
<style scoped>
  ...
  .three-box-wrap-middle-type{
    margin: 28px 0 17px;
    font-family: "PingFangSC-Regular";
    font-size: 24px;
    color: #333333;
  }
  .three-box-middle-radio>input{
    width: 24px;
    height: 24px;
    vertical-align: middle;
    margin-right: 12px;
  }
  .three-box-middle-radio>span{
    font-family: "PingFangSC-Regular";
    font-size: 20px;
    vertical-align: middle;
    font-weight: 300;
  ...
  .three-box-middle-radio>span:nth-of-type(1){
    margin-right: 45px;
  }
  .form_select {
...
.three-box-middle-box-company{
  margin: 28px 0;
}
.three-box-middle-box-company>p,.three-box-middle-box-ming>p{
  font-family: "PingFangSC-Regular";
  font-size: 24px;
  color: #333333;
}
.three-box-middle-box-company>span{
  font-family: "PingFangSC-Regular";
  font-size: 24px;
  color: #f96006;
  cursor: pointer;
}
.three-box-middle-box-registerNum{
    margin-bottom: 28px;
}
.three-box-middle-box-registerNum>div{
    margin-bottom: 15px;
    font-family: "PingFangSC-Regular";
    font-size: 24px;
    color: #333333;
}
.three-box-middle-box-registerNum>input{
     width: 776px;
     height: 40px;
     border-radius: 4px;
     border: solid 1px #d6d6d6;
...
.three-box-middle-box-evance{
    margin-bottom: 200px;
}
.three-box-middle-box-evance>div:nth-of-type(1){
     margin-bottom: 20px;
     font-family: "PingFangSC-Regular";
    font-size: 24px;
    color: #333333;
}
.three-box-middle-box-evance>div:nth-of-type(2)>div{
    float: left;
}
.three-box-middle-box-evance-des{
    font-family: "PingFangSC-Light";
    font-size: 16px;
    font-weight: 300;
    color: #a6a6a6;
}
.three-box-middle-two{
      height: 53px;
      margin-left: 540px;
    }
    .three-box-middle-two>div{
      float: left;
      width: 182px;
      height: 53px;
      border-radius: 8px;
    ...
    .three-box-middle-two>div:nth-of-type(1){
    ...
    .three-box-middle-two>div:nth-of-type(2){
