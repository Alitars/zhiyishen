<template>
  <div id="defence">
    ...
    <div class="defence-box">
      ...
      <div class="defence-box-wrap">
          <div class="defence-box-wrap-top"> 商标异议答辩</div>
          <div class="fail" v-if="status == '资料审核不通过'">审核不通过原因：{{remark}}</div>
          <div class="defence-box-wrap-middle">
            <div class="defence-box-wrap-middle-type">申请人类型：</div>
            <div class="defence-box-middle-radio">
              ...
              <div class="defence-box-middle-box-company" v-show="divshow">
                <p>企业全称：</p>
              ...
              <div class="defence-box-middle-box-registerNum">
                  <div>商标注册号：</div>
              ...
              <div class="defence-box-middle-box-evance">
                  <div>异议答辩材料：</div>
                  <div>
                      <div> 
                        <input type="file" @change="getFile($event)">
                    </div>
                    <div class="defence-box-middle-box-evance-des">
                        <p>资料包含(商品企业简介、企业发展历程、销售或使用等证明材料)</p>
                        <p>RAR或ZIP格式，压缩包200M以内，太大联系客服</p>
                    </div>
                  </div>
              </div>
              <div class="defence-box-middle-two">
...
<style scoped>
  ...
  .defence-box-wrap-middle-type{
    margin: 28px 0 17px;
    font-family: "PingFangSC-Regular";
    font-size: 24px;
    color: #333333;
  }
  .defence-box-middle-radio>input{
    width: 24px;
    height: 24px;
    vertical-align: middle;
    margin-right: 12px;
  }
  .defence-box-middle-radio>span{
    font-family: "PingFangSC-Regular";
    font-size: 20px;
    vertical-align: middle;
    font-weight: 300;
  ...
  .defence-box-middle-radio>span:nth-of-type(1){
    margin-right: 45px;
  }
  .form_select {
...
.defence-box-middle-box-company{
  margin: 28px 0;
}
.defence-box-middle-box-company>p,.defence-box-middle-box-ming>p{
  font-family: "PingFangSC-Regular";
  font-size: 24px;
  color: #333333;
}
.defence-box-middle-box-company>span{
  font-family: "PingFangSC-Regular";
  font-size: 24px;
  color: #f96006;
  cursor: pointer;
}
.defence-box-middle-box-registerNum{
    margin-bottom: 28px;
}
.defence-box-middle-box-registerNum>div{
    margin-bottom: 15px;
    font-family: "PingFangSC-Regular";
    font-size: 24px;
    color: #333333;
}
.defence-box-middle-box-registerNum>input{
     width: 776px;
     height: 40px;
     border-radius: 4px;
     border: solid 1px #d6d6d6;
...
.defence-box-middle-box-evance{
    margin-bottom: 200px;
}
.defence-box-middle-box-evance>div:nth-of-type(1){
     margin-bottom: 20px;
     font-family: "PingFangSC-Regular";
    font-size: 24px;
    color: #333333;
}
.defence-box-middle-box-evance>div:nth-of-type(2)>div{
    float: left;
}
.defence-box-middle-box-evance-des>p{
    font-family: "PingFangSC-Light";
    font-size: 16px;
    font-weight: 300;
    color: #a6a6a6;
}
.defence-box-middle-box-evance-des>p:nth-of-type(1){
    color: #f96006;
    margin-bottom: 8px;
}
.defence-box-middle-two{
      height: 53px;
      margin-left: 540px;
    }
    .defence-box-middle-two>div{
      float: left;
      width: 182px;
      height: 53px;
      border-radius: 8px;
    ...
    .defence-box-middle-two>div:nth-of-type(1){
    ...
    .defence-box-middle-two>div:nth-of-type(2){
