<template>
  <div id="threeApply">
    ...
    <div class="threeApply-box">
        <div class="threeApply-box-title">商标撤三申请</div>
        <div class="fail" v-if="status == '盖章资料未通过'">审核不通过原因：{{remark}}</div>
        <div class="threeApply-box-middle">
            <div class="threeApply-box-middle-top">
                <div class="threeApply-box-middle-top-img"></div>
                <div class="threeApply-box-middle-top-div">
                    <div>商标撤三申请申请书</div>
            ...
            <div class="threeApply-box-middle-bottom">
                <div>盖公章拍照上传</div>
                <div>
                    <el-upload
                    accept="image/*"
        ...
        <div class="threeApply-box-bottom">
            <div class="threeApply-box-middle-top">
                <div class="threeApply-box-middle-top-img"></div>
                <div class="threeApply-box-middle-top-div">
                    <div>商标代理委托书</div>
        ...
        <div class="threeApply-box-handle">
    ...
    methods:{
        ...
        give(){
            if(this.ser_img1 == ''||this.ser_img2 == ''){
                this.tip('error',"请上传商标撤三申请书或代理委托书盖章图片");
            }else{
...
<style scoped>
 ...
 .threeApply-box-middle{
     height: 415px;
     border-bottom: 1px solid #d8d8d8;
     padding: 48px 0 72px;
 }
 .threeApply-box-middle-top{
     height: 117px;
     margin-bottom: 52px;
 }
 .threeApply-box-middle-top>div{
     float: left;
 }
 .threeApply-box-middle-top-img{
     width: 117px;
     height: 117px;
 ...
 .threeApply-box-middle-top-div>div:nth-of-type(1){
     font-family: "PingFangSC-Regular";
     font-size: 32px;
     color: #333333;
     margin-bottom: 16px;
 }
 .threeApply-box-middle-top-div>div:nth-of-type(3){
     font-family: "PingFangSC-Regular";
     font-size: 16px;
     color: #f96006;
 }
 .threeApply-box-middle-top-div>div:nth-of-type(2)>a{
 ...
 .threeApply-box-middle-top-div>div:nth-of-type(2)>a:nth-of-type(1){
     margin-right: 119px;
 }
 .threeApply-box-middle-bottom{
     margin-left: 16px;
 }
 .threeApply-box-middle-bottom>div:nth-of-type(1){
     font-family: "PingFangSC-Regular";
     font-size: 20px;
     color: #333333;
     margin-bottom: 20px;
 ...
 .threeApply-box-bottom{
     height: 415px;
     padding-top: 48px;
 }
 .threeApply-box-handle{
     margin-top: 130px;
     margin-left: 630px;
     height: 41px;
 }
 .threeApply-box-handle>div{
     float: left;
     cursor: pointer;
     width: 214px;
     height: 41px;
 ...
 .threeApply-box-handle>div:nth-of-type(1){
 ...
 .threeApply-box-handle>div:nth-of-type(2){
