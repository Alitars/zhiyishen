<template>
  <div id="change">
    ...
    <div class="change-box">
        <div class="change-box-title">商标变更</div>
        <div class="fail" v-if="status == '盖章资料未通过'">审核不通过原因：{{remark}}</div>
        <div class="change-box-middle">
            <div class="change-box-middle-top">
                <div class="change-box-middle-top-img"></div>
                <div class="change-box-middle-top-div">
                    <div>商标变更申请书</div>
                    ...
                    <div v-show="!applyshow">商标变更申请书文件未上传</div>
                </div>
            </div>
            <div class="change-box-middle-bottom">
                <div>盖公章拍照上传</div>
                <div>
                    <el-upload
                    accept="image/*"
        ...
        <div class="change-box-bottom">
            <div class="change-box-middle-top">
                ...
                <div class="change-box-middle-top-div">
                    ...
                    <div v-show="!trust">商标变更委托书文件未上传</div>
                </div>
            </div>
            <div class="change-box-middle-bottom">
                <div>盖公章拍照上传</div>
    ...
    methods:{
        ...
        give(){
            if(this.ser_img1 == ''||this.ser_img2 == ''){
                this.tip('error',"请上传商标变更申请书或代理委托书盖章图片");
            }else{
...
<style scoped>
 ...
 .change-box-middle-top{
     height: 117px;
     margin-bottom: 52px;
 }
 .change-box-middle-top>div{
     float: left;
 }
 .change-box-middle-top-img{
     width: 117px;
     height: 117px;
 ...
 .change-box-middle-top-div>div:nth-of-type(1){
     font-family: "PingFangSC-Regular";
     font-size: 32px;
     color: #333333;
     margin-bottom: 16px;
 }
 .change-box-middle-top-div>div:nth-of-type(3){
     font-family: "PingFangSC-Regular";
     font-size: 16px;
     color: #f96006;
 }
 .change-box-middle-top-div>div:nth-of-type(2)>a{
 ...
 .change-box-middle-top-div>div:nth-of-type(2)>a:nth-of-type(1){
     margin-right: 119px;
 }
 .change-box-middle-bottom{
     margin-left: 16px;
 }
 .change-box-middle-bottom>div:nth-of-type(1){
     font-family: "PingFangSC-Regular";
     font-size: 20px;
     color: #333333;
     margin-bottom: 20px;
 ...
 .change-box-handle>div:nth-of-type(1){
 ...
 .change-box-handle>div:nth-of-type(2){
