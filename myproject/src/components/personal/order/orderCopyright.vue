...
export default {
  ...
  methods:{
    ...
    confireQuit(){
      ...
      this.$http.post(this.GLOBAL.base_url+'/api/copyRight/orderEnd',{
        user_id:this.$cookie.getCookie('u_id'),
        id:this.id,
    ...
    changeType(value){
      ...
      window.location.href='https://'+ host +"/personal/orderCopyright?status="+strs[1]
    ...
    getList(){
          ...
          if(this.changeStatus == 'all') {
            if(this.form2.zhi == '全部类型') {
                this.$http.post(this.GLOBAL.base_url+'/api/copyRight/orderList',{
                user_id:this.$cookie.getCookie('u_id'),
