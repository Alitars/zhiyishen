<template>
  <div class="patentNew">
    <Top></Top>
    <Fix></Fix>
    <div class="patentNew-box">
      <!-- 头部 -->
      <div class="patentNew-box-top">实用新型专利申请</div>
      <div class="fail" v-if="this.$route.query.status == '资料审核不通过'">审核不通过原因：{{remark}}</div>
      <!-- 类型 -->
      <div class="patentNew-box-type">
        <span>申请人类型</span>
      ...
      <!-- 企业申请人 -->
      <div class="patentNew-box-applicant" v-show="divshow">
        <span>第1专利申请人：</span>
      ...
      <!-- 共同申请人  -->
      <div v-for="(item,index) in count" class="patentNew-box-applicant" v-if="divshow">
      ...
      <!-- 个人共同申请人 -->
      <div v-for="(item,index) in count" class="patentNew-box-applicant" v-show="!divshow">
        <span>第{{index+2}}专利申请人：</span>
        <select v-model="item.name">
          <option value="0">请选择</option>
          <option v-for="(v,k) in arr1" v-bind:value="v.id">{{v.chinese_name}}</option>
      ...
      <!-- 已同报 -->
       <div class="patentNew-box-orderNumber" v-show="withShow">
        <span>同报专利订单：</span>
        <span>{{orderNumber}}</span>
      </div>
      <!-- 未同报专利 -->
      <div class="patentNew-box-type" v-show="!withShow">
        <span>同报专利</span>
      ...
      <!-- 未同报专利订单 -->
      <div class="patentNew-box-applicant " v-show="div1show">
        <span>同报专利订单：</span>
        <select v-model="chose5" @change='getValue5'>
          <option value="请选择同报订单">{{chose5Name}}</option>
          <option  v-for="(v,k) in arr3" v-bind:value="v">{{v}}</option>
        </select>
      ...
      <!--申报表A类 -->
      <div class="patentNew-box-declareA" v-show="apper1&&showTf">
      ...
      <!-- 个人收入 -->
       <div class="patentNew-box-declareA" v-show="apper&&showTf">
      ...
      <!-- 提交取消 -->
      <div class="patentNew-box-delSub">
    ...
    methods:{
      ...
      update(e) {
        ...
        if(formData.get('url_img') !=  "undefined" ) {
          ...
          localStorage.setItem('name3', this.name1)
          let config = {
      ...
      updateCAD(e) {
        ...
        if(formData.get('url_img') !=  "undefined" ) {
          ...
          localStorage.setItem('name4', this.name2)
          let config = {
            headers:{'Content-Type':'multipart/form-data'}
          };
          this.$http.post(this.GLOBAL.base_url+'/api/BrandUpload/brandUploadFile',formData).then( res => {
...
        window.open(routeData.href, '_blank');
    ...
    created(){
      ...
      if(this.$route.query.edit == "2") {
        this.getData2();
        this.name1 = localStorage.getItem("name3")
        this.name2 = localStorage.getItem("name4")
      }
      this.getData3()
    },
    watch:{
...
/* 公共样式 */
 input {
  ...
  .patentNew-box-type > span:nth-child(1) {
    display: block;
    margin-bottom: 17px;
    font-family: "PingFangSC";
    font-size: 18px;
  ...
  .patentNew-box-type > span:nth-child(3) {
    /* display: block; */
    /* margin-bottom: 17px; */
    font-family: "PingFangSC";
    font-size: 14px;
   ...
   .patentNew-box-type > span:nth-child(5) {
    font-family: "PingFangSC";
    font-size: 14px;
    color: #333;
    font-weight: 300;
  }
  .patentNew-box-type > div {
    font-family: "PingFangSC";
    font-size: 14px;
    color: #f96006;
    font-weight: 300;
  ...
  .patentNew-box-type > div > img {
    /* margin-right: 6px; */
    vertical-align: middle;
    position: relative;
  }
  .patentNew-box-type > div > span {
    vertical-align: middle;
    border-bottom: 1px solid #f96006;
  }
  /* 专利申请人 */
  .patentNew-box-applicant>span:nth-child(1) {
    font-family: "PingFangSC";
    font-size: 18px;
    color: #333;
    display: block;
  ...
  .patentNew-box-applicant > select {
    width: 744px;
    height: 40px;
    line-height: 40px;
    padding-left: 8px;
  ...
  .patentNew-box-applicant>span:nth-child(3) {
    font-family: "PingFangSC";
    font-size: 16px;
    color: #f96006;
  ...
  .patentNew-box-applicant>span:nth-child(4) {
    font-family: "PingFangSC";
    font-size: 16px;
    color: #4a90e2;
    cursor: pointer;
  ...
  .patentNew-box-one>span:nth-child(1) {
    font-family: "PingFangSC";
    font-size: 18px;
    color: #333;
    display: block;
  ...
  .patentNew-box-one>span:nth-child(3) {
    font-family:" PingFangSC";
    font-size: 16px;
    font-weight: 300;
    color: #f96006;
  ...
  .patentNew-box-two >span:nth-child(1) {
    font-family: "PingFangSC";
    font-size: 18px;
    color: #333;
    display: block;
  ...
  .patentNew-box-two > div:nth-child(2) {
    width: 744px;
    height: 40px;
  ...
  .patentNew-box-two >span:nth-child(5) {
    position: absolute;
    top: 50px;
    right: -330px;
    font-family: "PingFangSC";
  ...
  /* 申报表A类&&申报表A类封面 */
  .patentNew-box-declareA > span:nth-child(1) {
    display: block;
    font-family: "PingFangSC";
    font-size: 18px;
    color: #333;
  ...
  .patentNew-box-declareA > div:nth-child(2) {
  ...
  .patentNew-box-declareA > span:nth-child(3) {
    font-family: "PingFangSC";
    font-size: 16px;
    font-weight: 300;
    color: #f96006;
  ...
  /* 取消保存 */
  .patentNew-box-delSub {
    text-align: center;
    margin-top: 68px;
    margin-bottom: 80px;
  }
  .patentNew-box-delSub > span {
    width: 80px;
    height: 36px;
    line-height: 36px;
    display: inline-block;
  ...
  .patentNew-box-delSub > span:nth-child(1) {
    background-color: #efefef;
    border-radius: 4px;
    color: #f87e03;
    margin-right: 16px;
  }
  .patentNew-box-delSub > span:nth-child(2) {
  ...
  /* 已同报 */
  .patentNew-box-orderNumber {
    font-family: "PingFangSC";
    font-size: 18px;
    color: #333;
    margin-bottom: 16px;
  }
  .patentNew-box-orderNumber > span:nth-child(2) {
    font-family: "PingFangSC";
    font-size: 16px;
    color: #999999;
  }
