<template>
  <div class="patentAppearance">
    <Top></Top>
    <Fix></Fix>
    <div class="patentAppearance-box">
      <!-- 头部 -->
      <div class="patentAppearance-box-top">
        外观设计专利申请
      </div>
      <div class="fail" v-if="this.$route.query.status == '资料审核不通过'">审核不通过原因：{{remark}}</div>
      <!-- 类型 -->
      <div class="patentAppearance-box-type">
        <span>申请人类型</span>
      ...
      <!-- 企业申请人 -->
      <div class="patentAppearance-box-applicant" v-show="divshow">
        <span>第1专利申请人：</span>
      ...
      <!-- 共同申请人  -->
      <div v-for="(item,index) in count" class="patentAppearance-box-applicant" v-if="divshow">
        <span>第{{index+2}}共同专利申请人：</span>
      ...
      <!-- 个人共同申请人 -->
      <div v-for="(item,index) in count" class="patentAppearance-box-applicant" v-show="!divshow">
        <span>第{{index+2}}共同专利申请人：</span>
        <select v-model="item.name">
          <option value="0">请选择</option>
          <option v-for="(v,k) in arr1" v-bind:value="v.id">{{v.chinese_name}}</option>
      ...
      <!-- 第一发明人姓名 -->
      <div class="patentAppearance-box-one">
        <span>第一发明人姓名：</span>
      ...
      <!-- 六视图或七视图 -->
      <div class="patentAppearance-box-two">
        <span>六视图或七视图</span>
        <!-- <div>{{name1}}</div> -->
        <!-- <div>{{name1}}</div> -->
      ...
      <!--申报表A类 -->
      <div class="patentAppearance-box-declareA" v-show="apper1&&showTf">
      ...
      <!-- 个人收入 -->
       <div class="patentAppearance-box-declareA" v-show="apper&&showTf">
      ...
      <!-- 提交取消 -->
      <div class="patentAppearance-box-delSub">
        <button  @click="back()">取消</button>
        <button  @click="addinvoice" :disabled = "isDisabled">保存</button>
      </div>
    </div>
    <Foot></Foot>
  </div>
    ...
    methods:{
      ...
      update(e) {
        ...
        if(formData.get('url_img') !=  "undefined" ) {
          ...
          localStorage.setItem('name11',this.name1)
          let config = {
      ...
      updateCAD(e) {
        ...
        if(formData.get('url_img') !=  "undefined" ) {
          ...
          localStorage.setItem('name12',this.name2)
          let config = {
            headers:{'Content-Type':'multipart/form-data'}
          };
          this.$http.post(this.GLOBAL.base_url+'/api/BrandUpload/brandUploadFile',formData).then( res => {
...
        window.open(routeData.href, '_blank');
    ...
    created(){
      ...
      if(this.$route.query.edit == "2") {
        this.getData2();
        this.name1 = localStorage.getItem('name11')
        this.name2 = localStorage.getItem('name12')
      }
    },
    watch:{
      // 申请企业
...
/* 公共样式 */
 input {
  ...
  /* 类型&&申请专利费用减缓 */
  .patentAppearance-box-type {
    /* margin-top: 26px; */
    margin-bottom:26px;
    position: relative;
  }
  .patentAppearance-box-type > span:nth-child(1) {
    display: block;
    margin-bottom: 17px;
    font-family: "PingFangSC";
    font-size: 18px;
  ...
  .patentAppearance-box-type > input {
    width: 16px;
    height: 16px;
    cursor: pointer;
  ...
  .patentAppearance-box-type > span:nth-child(3) {
    /* display: block; */
    /* margin-bottom: 17px; */
    font-family: "PingFangSC";
    font-size: 14px;
   ...
   .patentAppearance-box-type > span:nth-child(5) {
    font-family: "PingFangSC";
    font-size: 14px;
    color: #333;
    font-weight: 300;
  }
  .patentAppearance-box-type > div {
    font-family: "PingFangSC";
    font-size: 14px;
    color: #f96006;
    font-weight: 300;
  ...
  .patentAppearance-box-type > div > img {
    /* margin-right: 6px; */
    vertical-align: middle;
    position: relative;
  }
  .patentAppearance-box-type > div > span {
    vertical-align: middle;
    border-bottom: 1px solid #f96006;
  }
  /* 专利申请人 */
  .patentAppearance-box-applicant>span:nth-child(1) {
    font-family: "PingFangSC";
    font-size: 18px;
    color: #333;
    display: block;
  ...
  .patentAppearance-box-applicant > select {
    width: 744px;
    height: 40px;
    line-height: 40px;
    padding-left: 8px;
  ...
  .patentAppearance-box-applicant>span:nth-child(3) {
    font-family: "PingFangSC";
    font-size: 16px;
    color: #f96006;
  ...
  .patentAppearance-box-applicant>span:nth-child(4) {
    font-family: "PingFangSC";
    font-size: 16px;
    color: #4a90e2;
    cursor: pointer;
  ...
  .patentAppearance-box-one>span:nth-child(1) {
    font-family: "PingFangSC";
    font-size: 18px;
    color: #333;
    display: block;
  ...
  .patentAppearance-box-one>span:nth-child(3) {
    font-family:" PingFangSC";
    font-size: 16px;
    font-weight: 300;
    color: #f96006;
  ...
  /* 技术交底书&&CAD图纸 */
  .patentAppearance-box-two {
    width: 744px;
    position: relative;
  }
  .patentAppearance-box-two >span:nth-child(1) {
    font-family: "PingFangSC";
    font-size: 18px;
    color: #333;
    display: block;
  ...
  .patentAppearance-box-two > div:nth-child(2) {
    width: 744px;
    height: 40px;
  ...
  .patentAppearance-box-two > label {
    width: 88px;
    height: 40px;
    display: block;
  ...
  .patentAppearance-box-two >span:nth-child(5) {
    position: absolute;
    top: 50px;
    right: -330px;
    font-family: "PingFangSC";
  ...
  /* 申报表A类&&申报表A类封面 */
  .patentAppearance-box-declareA > span:nth-child(1) {
    display: block;
    font-family: "PingFangSC";
    font-size: 18px;
    color: #333;
  ...
  .patentAppearance-box-declareA > div:nth-child(2) {
  ...
  .patentAppearance-box-declareA > span:nth-child(3) {
    font-family: "PingFangSC";
    font-size: 16px;
    font-weight: 300;
    color: #f96006;
  ...
  /* 取消保存 */
  .patentAppearance-box-delSub {
    text-align: center;
    margin-top: 68px;
    margin-bottom: 80px;
  }
  .patentAppearance-box-delSub > button {
    width: 80px;
    height: 36px;
    line-height: 36px;
    display: inline-block;
  ...
  .patentAppearance-box-delSub > button:nth-child(1) {
    background-color: #efefef;
    border-radius: 4px;
    color: #f87e03;
    margin-right: 16px;
  }
  .patentAppearance-box-delSub > button:nth-child(2) {
  ...
  /* 已同报 */
  .patentAppearance-box-orderNumber {
    font-family: "PingFangSC";
    font-size: 18px;
    color: #333;
    margin-bottom: 16px;
  }
  .patentAppearance-box-orderNumber > span:nth-child(2) {
    font-family: "PingFangSC";
    font-size: 16px;
    color: #999999;
  }
