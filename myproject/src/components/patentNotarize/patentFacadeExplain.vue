<template>
  <div class="patentFacadeExplain">
    <Top></Top>
    <Fix></Fix>
    <div class="patentFacadeExplain-box">
      <!-- top -->
      <div class="patentFacadeExplain-box-top">
        外观设计专利申请--专利说明书已撰写
      </div>
      <!-- 说明书 -->
      <div class="patentFacadeExplain-box-one">
        <div class="one-left">
        ...
        <!--  选择  -->
      <div class="patentFacadeExplain-box-select">
        <p>是否同意</p>
      ...
      <!-- 委托书 -->
      <div class="patentFacadeExplain-box-one" v-show="!switch2">
        <div class="one-left">
          <img src="/static/images/datawrite.png" alt="">
        </div>
        <div class="one-right">
       ...
       <div class="patentFacadeExplain-box-upload" v-show="!switch2">
        <div class="patentFacadeExplain-box-upload-left">
          <p>盖公章拍照上传</p>
          <el-upload
            accept="image/*"
        ...
        <div class="patentFacadeExplain-box-upload-right">
          <p>* 1.下载的委托书会自动填充信息；</p>
      ...
      <!-- 意见 -->
      <div class="patentFacadeExplain-box-idea" v-show="switch2">
        <p>修改意见：</p>
        <textarea name="" id=""  v-model="text" placeholder="非必填"></textarea>
      </div>
      <!-- 提交&&取消 -->
      <div class="patentFacadeExplain-box-submit">
...
<style scoped>
  ...
  /*  */
  .patentFacadeExplain-box-upload-left {
    float: left;
    margin-left:30px;
  }
  .patentFacadeExplain-box-upload-left > p {
    margin-bottom: 20px;
    font-family: "PingFangSC";
    font-size: 20px;
    color: #333;
  ...
  .patentFacadeExplain-box-upload-right {
    float: left;
    margin-left: 16px;
    font-family: "PingFangSC";
    font-size: 22px;
  ...
  .patentFacadeExplain-box-upload-right >p:nth-child(2) {
    margin:2px 0 0 14px;
  }
  /* 选择 */
  .patentFacadeExplain-box-select {
    margin: 0px 0 72px 30px;
  }
  .patentFacadeExplain-box-select > p {
    font-family: "PingFangSC";
    font-size: 20px;
    margin-bottom: 16px;
    color: #333333;
  }
  .patentFacadeExplain-box-select > input {
    width: 18px;
    height: 18px;
  ...
  .patentFacadeExplain-box-select > span {
    font-family: "PingFangSC";
    font-size: 20px;
    vertical-align: middle;
    margin-right: 65px;
  ...
  /* 意见 */
  .patentFacadeExplain-box-idea {
    border-top: 1px solid #d8d8d8;
    margin-top: 72px;
    padding-top: 36px;

  }
  .patentFacadeExplain-box-idea > p {
    box-sizing: border-box;
    font-family: "PingFangSC";
    font-size: 18px;
    color: #333333;
  ...
  .patentFacadeExplain-box-idea > textarea {
    width: 1128px;
    height: 128px;
    margin-left: 36px;
  ...
  /* 提交&&取消 */
  .patentFacadeExplain-box-submit {
    float: right;
    margin:64px 104px 0 0 ;
  }
  .patentFacadeExplain-box-submit > span {
    width: 214px;
    height: 40px;
  ...
  .patentFacadeExplain-box-submit > span:nth-child(1) {
  ...
  .patentFacadeExplain-box-submit > span:nth-child(2) {
