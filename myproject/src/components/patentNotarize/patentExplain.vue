<template>
  <div class="patentExplain">
    <Top></Top>
    <Fix></Fix>
    <div class="patentExplain-box">
      <!-- top -->
      <div class="patentExplain-box-top">
        发明专利申请--专利说明书已撰写
      </div>
      <!-- 说明书 -->
      <div class="patentExplain-box-one">
        <div class="one-left">
        ...
        <!--  选择  -->
      <div class="patentExplain-box-select">
        <p>是否同意</p>
      ...
      <!-- 委托书 -->
      <div class="patentExplain-box-one" v-show="!switch2">
        <div class="one-left">
          <img src="/static/images/datawrite.png" alt="">
        </div>
        <div class="one-right">
       ...
       <div class="patentExplain-box-upload" v-show="!switch2">
        <div class="patentExplain-box-upload-left">
          <p>盖公章拍照上传</p>
          <el-upload
            accept="image/*"
        ...
        <div class="patentExplain-box-upload-right">
          <p>* 1.下载的委托书会自动填充信息；</p>
      ...
      <!-- 意见 -->
      <div class="patentExplain-box-idea" v-show="switch2">
        <p>修改意见：</p>
        <textarea name="" id=""  v-model="text" placeholder="非必填"></textarea>
      </div>
      <!-- 提交&&取消 -->
      <div class="patentExplain-box-submit">
...
<style scoped>
  ...
  .patentExplain-box-upload-left {
    float: left;
    margin-left:30px;
  }
  .patentExplain-box-upload-left > p {
    margin-bottom: 20px;
    font-family: "PingFangSC";
    font-size: 20px;
    color: #333;
  ...
  .patentExplain-box-upload-right {
    float: left;
    margin-left: 16px;
    font-family: "PingFangSC";
    font-size: 22px;
  ...
  .patentExplain-box-upload-right >p:nth-child(2) {
    margin:2px 0 0 14px;
  }
  /* 选择 */
  .patentExplain-box-select {
    margin: 0px 0 72px 30px;
  }
  .patentExplain-box-select > p {
    font-family: "PingFangSC";
    font-size: 20px;
    margin-bottom: 16px;
    color: #333333;
  }
  .patentExplain-box-select > input {
    width: 18px;
    height: 18px;
  ...
  /* 意见 */
  .patentExplain-box-idea {
    border-top: 1px solid #d8d8d8;
    margin-top: 72px;
    padding-top: 36px;

  }
  .patentExplain-box-idea > p {
    box-sizing: border-box;
    font-family: "PingFangSC";
    font-size: 18px;
    color: #333333;
  ...
  .patentExplain-box-idea > textarea {
    width: 1128px;
    height: 128px;
    margin-left: 36px;
  ...
  /* 提交&&取消 */
  .patentExplain-box-submit {
    float: right;
    margin:64px 104px 0 0 ;
  }
  .patentExplain-box-submit > span {
    width: 214px;
    height: 40px;
  ...
  .patentExplain-box-submit > span:nth-child(1) {
  ...
  .patentExplain-box-submit > span:nth-child(2) {
